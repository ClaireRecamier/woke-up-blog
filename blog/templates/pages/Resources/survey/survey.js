...
if(Female&&Asian&&!Hispanic){document.getElementById("results").innerHTML="Asian females should not wear bindis(unless  Indian), Native American headresses, cornrows,hoop earrings, sombreros, afros, hijabs(unless of middle eastern ethncity and is a practcing muslim), black face,bantu knots, durags,grillz,bandanas,black face,dreadlocks,twists,dashikis, head pieces,and name plate necklaces.<br> <img src=\"http://pa1.narvii.com/5842/16a9ee4ac39666e2c5461d447eca4b2fbd73cd3d_hq.gif\"> <br> no honey....";
}
